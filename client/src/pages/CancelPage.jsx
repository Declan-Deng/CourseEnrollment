  ...
  return (
    <div className="page-stack page-stack--withdraw">
      ...
      <section className="page-panel page-panel--focus">
        ...
        <p>
          Requests that can still be withdrawn online appear here: requests inside the withdrawal window, plus lottery
          entries, which stay withdrawable until the programme office resolves the pool. Withdraw window-bound requests
          before {requestDeadline}. All other request history stays in View Enrolment Results.
        </p>
