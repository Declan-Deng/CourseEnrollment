...
export function usePortalController() {
  ...
  function handleTopLinkClick(link) {
    ...
    // Signing out is a pure client-side view change in this demo: it must not
    // touch backend state. Resetting demo data stays a separate, explicit action.
    setBanner(null);
    setInfoDialog(null);
    ...
    showStatusToast({
      tone: "info",
      title: "Signed out of the demo portal.",
      detail: "Your enrolment data was kept. Use “Reset demo data” on this page if you want a clean start.",
    });
  }
